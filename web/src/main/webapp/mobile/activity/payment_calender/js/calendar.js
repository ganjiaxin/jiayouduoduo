(function (root, factory) {
    ...
    var defaults = {
        ...
        DAY_ITEM_TPL = '<li ' + ITEM_STYLE + ' class="{class}" {action}>{value}<i class="circle"></i></li>',
        ...
        TEMPLATE = [
            ...
            '{yyyy}/<span class="m" id="mouth_id">{mm}</span>',
            '</a>',
    ...
    function Calendar(element, options) {
        ...
        this.data = this.options.data.list;
        this.init();
    }

    // function dateFormat(now, fmt) {
    ...
    Calendar.prototype = {
        ...
        getDayData: function (day) {
            ...
            if (data) {
                for (var i = 0, len = data.length; i < len; i++) {
                    var item = data[i], date = item.date;
                    if (day.isSame(date.toDate())) {
                        ret = item;
                    }
                }
            }
        ...
        getDayItem: function (y, m, d, f) {
            ...
            if (markData) {
                ...
                for (var i = 0; i < markData.list2.length; i++) {
                    $item.html(d + '<i class="circle isback"><i class="dot"></i></i>');
                }
            }
            return $item;
        },
        ...
        selectedDay: function (d, type) {
            var arr = this.getDisDateValue(),
                ...
                toggleClass = function () {
                    this.$dateItems.children(':eq(1)').find('[' + ITEM_DAY + ']:not(.' + NEW_DAY_CLASS + ', .' + OLD_DAY_CLASS + ')')
