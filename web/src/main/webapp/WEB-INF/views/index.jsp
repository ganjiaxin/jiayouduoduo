...
<html>
<script src="<%=basePath%>/static/hykweb/js/jquery-1.8.3.min.js" type="text/javascript"></script>
<body>
...
<script>
    var token;
    var path="http://localhost:8082/hyk-web";
    function register(){
        $.ajax({
            url : path+"/f/app/register",
    ...
    function login(){
        ...
        $.ajax({
            url : path+"/f/app/login",
            data:{phone:"13714536220",password:"12345678"},
            type: "post",
            dataType:"json",
            success :function(data){
                token=data.token;
