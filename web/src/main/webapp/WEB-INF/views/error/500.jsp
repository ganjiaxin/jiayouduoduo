...
<%@page import="com.hyk.code.common.web.Servlets"%>
<%@page import="com.hyk.code.common.utils.Exceptions"%>
<%@page import="com.hyk.code.common.utils.StringUtils"%>
<%@page contentType="text/html;charset=UTF-8" isErrorPage="true"%>
<%@include file="/WEB-INF/views/includ/taglib.jsp"%>
<!DOCTYPE html>
<html>
<head>
	<title>500 - 系统内部错误</title>
	<%@include file="/WEB-INF/views/includ/head.jsp" %>
</head>
<body>
