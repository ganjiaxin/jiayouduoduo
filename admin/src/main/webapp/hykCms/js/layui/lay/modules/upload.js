...
layui.define('layer', function (exports) {
    ...
    Upload.prototype.init = function () {
        ...
        return elem.each(function (index, item) {
            item = $(item);
            var form = '<form  id="upfile" method="' + (options.method || 'post') + '"  enctype="multipart/form-data" action="' + (options.url || '') + '"></form>';
    ...
    Upload.prototype.action = function (input, type) {
        ...
        var params = options.multipart_params;
        for (var property in params) {
            item.parent().prepend('<input type="hidden" name="' + property + '" value="' + params[property] + '" >');
        }
