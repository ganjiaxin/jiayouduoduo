...
;layui.define(function (e) {
    ...
    t.laydate = function (e) {
        ...
        t && (d.elemv = /textarea|input/.test(t.tagName.toLocaleLowerCase()) ? "value" : "innerHTML", ("init" in e ? e.init : a.init) && !t[d.elemv], n.view(t, e), n.reshow())
    }, n.scroll = function (e) {
        ...
        n.addClass(s.body, "laydate_body"), d.tds = e("#laydate_table td"), d.mms = e("#laydate_ms span"), d.year = e("#laydate_y"), d.month = e("#laydate_m"), n.each(e(a.box + " .laydate_ym"), function (e, t) {
            ...
            n.elem[d.elemv] = "", n.close(), n.options.clear && n.options.clear()
        ...
        var a = new Date(0 | e ? function (e) {
            ...
            return n.parse([a.getFullYear(), a.getMonth() + 1, a.getDate()],[], t)
        //return n.parse([a.getFullYear(), a.getMonth() + 1, a.getDate()],[], t)
