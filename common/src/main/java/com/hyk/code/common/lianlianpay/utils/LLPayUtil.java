...
public class LLPayUtil{
     ...
     * @return
     */
    public static String createRiskItem(OrderInfo orders)
    {
        net.sf.json.JSONObject riskItemObj = new net.sf.json.JSONObject();

        riskItemObj.put("frms_ware_category", "1015");
        riskItemObj.put("user_info_mercht_userno", orders.getUser_id());
        riskItemObj.put("user_info_dt_register", getCurrentDateTimeStr(orders.getRegisterDate()));
        riskItemObj.put("user_info_bind_phone",orders.getPhone());
        riskItemObj.put("goods_name",orders.getName_goods());
        /*frms_ware_category 商品类目传 1015
