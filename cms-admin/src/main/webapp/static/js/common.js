...
function showTip(mess, type, timeout, lazytime){
	...
	setTimeout(function(){
		top.layer.msg(mess, {
		    time:lazytime == undefined ? 2000 : lazytime}
		 ); 
...
function openDialog(title,url,width,height,target){
	...
	layer.open({
	    ...
	    yes: function(index, layero){
	         ...
	         //alert(iframeWin.documentWindow);
	         //console.log(iframeWin.documentWindow);
 ...
 * @returns
 */
function hideStr(str,maxlength){
	if(maxlength<=0){
		return "";
	}
