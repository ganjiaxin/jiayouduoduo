...
<head>
    ...
    <meta name="keywords" content="${fns:getConfig('keywords')}">
    <meta name="description" content="${fns:getConfig('description')}">
    <!--[if lt IE 9]>
...
<script
	src="${ctxStatic}/js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script
	src="${ctxStatic}/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script
	src="${ctxStatic}/js/plugins/validate/jquery.validate.min.js"></script>
...
<script src="${ctxStatic}/layer3.3/layer.js"></script>
...
<link href="${ctxStatic}/css/jeeqin.css?v=4.1.0" rel="stylesheet">
<script src="${ctxStatic}/js/common.js?v=3.3.6"></script>
<!-- 自定义js -->
<script src="${ctxStatic}/js/content.js?v=1.0.0"></script>

<link rel="stylesheet"
	href="${ctxStatic}/css/plugins/dataTables/dataTables.bootstrap.css">
	<!-- Bootstrap table -->
	<script
	...
	<!-- Peity -->
	<script src="${ctxStatic}/js/demo/bootstrap-table-demo.js"></script>
    ...
    <div id="wrapper">
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li><a class="J_menuItem" href="${ctx}/oa/oaNotify/self">信箱</a>
                                </li>
                                <li class="divider"></li>
                 ...
                 <c:forEach var="entry" items="${menuList}">
				   <li id="lm${entry.id}">
					 <a>
					  ...
					  <c:if test="${not empty entry.childMenu}">
					    <ul class="nav nav-second-level">
							<c:forEach var="sub" items="${entry.childMenu}">
								<c:choose>
								<c:when test="${not empty sub.childMenu}">
									<li id="lm${sub.id}">
									<a class="J_menuItem" >
									 ...
									 <ul class="nav nav-third-level">
									 	<c:forEach var="child" items="${sub.childMenu}">
									 		<li id="${child.id}" >
												<a  class="J_menuItem" href="${ctx}${child.href}"><i class="${sub.icon}"></i>${child.name}</a>
											</li>
									 	</c:forEach>
									 </ul>
									 </li>
								...
								<c:otherwise>
									<li id="${sub.id}">
									<a  class="J_menuItem" href="${ctx}${sub.href}"><i class="${sub.icon}"></i>${sub.name}</a>
									</li>
								</c:otherwise> 
								</c:choose>
							</c:forEach>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" id="mainFrame" name="mainFrame"   width="100%" height="100%" src="${ctx}/loginIndex"   frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
