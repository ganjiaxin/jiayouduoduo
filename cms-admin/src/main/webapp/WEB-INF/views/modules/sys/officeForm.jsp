	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<sys:ckfinder input="logo" type="files" uploadPath="/sys/office" selectMultiple="false"/>
				<span class="help-inline"><font color="red">*(尺寸：44*44)</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">是否总公司:</label>
			<div class="controls">
				<form:select path="stat">
					<form:options items="${fns:getDictList('stat_gs')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
