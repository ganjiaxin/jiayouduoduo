 ...
 */
package com.hyk.code.modules.gen.util;
...
import com.hyk.code.common.mapper.JaxbMapper;
import com.hyk.code.common.utils.DateUtils;
import com.hyk.code.common.utils.FileUtils;
import com.hyk.code.common.utils.FreeMarkers;
import com.hyk.code.common.utils.StringUtils;
import com.hyk.code.modules.gen.entity.GenCategory;
import com.hyk.code.modules.gen.entity.GenConfig;
...
//			}
			...
			//默认varchar(2)的类型为数据字典使用下拉框并使用字段名的字典类型
			if(StringUtils.startsWithIgnoreCase(column.getJdbcType(), "varchar(2)")){
