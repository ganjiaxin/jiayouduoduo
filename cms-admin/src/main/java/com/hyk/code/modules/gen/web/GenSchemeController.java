 ...
 */
package com.hyk.code.modules.gen.web;
...
import com.hyk.code.modules.gen.service.GenSchemeService;
import com.hyk.code.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.hyk.code.modules");
		}
