 ...
 */
package com.hyk.code.modules.sys.utils;
...
public class UserUtils {
	...
	public static void clearCache(){
		...
		removeCache(CACHE_MENU_LIST_PER);
	...
	public static List<Menu> getMenuList(){
		@SuppressWarnings("unchecked")
		List<Menu> menuList = (List<Menu>)getCache(CACHE_MENU_LIST_PER);
		if (menuList == null){
			User user = getUser();
			if (user.isAdmin()){
			...
			putCache(CACHE_MENU_LIST_PER, menuList);
		}
		return menuList;
	}
	/**
	...
	public static List<Menu> getMenuList(User user){
		@SuppressWarnings("unchecked")
		List<Menu> menuList = (List<Menu>)getCache(CACHE_MENU_LIST_HYK);
		if (menuList == null){
			if (user.isAdmin()){
				menuList = menuDao.findAllList(new Menu());
			}else{
				Menu m = new Menu();
				m.setUserId(user.getId());
				menuList = menuDao.findHykByUserId(m);
			}
			putCache(CACHE_MENU_LIST_HYK, menuList);
		}
		return menuList;
	}
