 ...
 */
package com.hyk.code.common.service;
...
public abstract class CrudService<D extends CrudDao<T>, T extends DataEntity<T>> extends BaseService {
	...
	public List<T> findList(T entity) {
		...
		if(user.getLoginName()!=null&&user.getLoginName()!=""&&user.getLoginName()!="null") {
			entity.getSqlMap().put("dsf", dataScopeFilter(user.getCurrentUser(), "o", "a"));
		}else {
			entity.getSqlMap().put("dsf", "");
		}
