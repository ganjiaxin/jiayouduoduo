...
public class ZxingCode {
	...
	public static void main(String[] args) throws Exception {
		String qrcode=ZxingCode.registeredTwoDimensional("D:/","15990050101","1047");
	 ...
	 * @throws Exception
	 */
	public static String registeredTwoDimensional(String path,String tj,String tjcode) throws Exception {
		Entity_Zxing zxing = new Entity_Zxing();   //"https://www.huiucard.com/hykweb/mobile/activity/share/reg.html?tjcode=1045&tj=18989475343
		zxing.setContents(wechatUtils.wxSaler_url+"https://www.huiucard.com/hykweb/mobile/activity/share/reg.html?tjcode="+tjcode+"&tj="+tj);//注册地址
		zxing.setCharacterSet("UTF-8");
		zxing.setErrorCorrectionLevel(ErrorCorrectionLevel.H);
		zxing.setFlag(false);
		zxing.setFormat("png");
		...
		zxing.setWidth(300);
		zxing.setHeight(300);
		zxing.setPath(path+"upload/qrcode/");// String path=request.getSession().getServletContext().getRealPath("/")
		zxing.setLogoPath("OXOXO");//不填
		String fileName=System.currentTimeMillis()+ ZxingHandler.getVerificationCode(3);
		System.out.println(fileName);
		zxing.setFilename(fileName);//二维码
		ZxingCode code = new ZxingCode();
		String codeUrl=code.encode(zxing);
		System.out.println("生成二维码成功："+codeUrl);
		return "/upload/qrcode/"+fileName+".png";
	}
