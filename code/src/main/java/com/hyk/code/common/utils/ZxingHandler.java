...
public class ZxingHandler {
     ...
     * @return
     */
    public static String getShopOrderStr(String userId) {
        String str = "s" + System.currentTimeMillis() / 1000 + "" + userId;
        return str;
    }
    ...
    public static void main(String[] args) {
        getVerificationCode(4);
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        try {
            String str = getShopOrderStr("1122");
