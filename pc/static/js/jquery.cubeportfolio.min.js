...
!function(a, b, c, d) {
    ...
    function e(b, c, d) {
        ...
        f = g.$obj.children(),
        g.options.caption && ("expand" === g.options.caption || e["private"].modernBrowser || (g.options.caption = "minimal"),
        h += " cbp-caption-active cbp-caption-" + g.options.caption),
        g.$obj.addClass(h),
        (0 === f.length || f.first().hasClass("cbp-item")) && (g.wrapInner(g.obj, "cbp-wrapper"),
        g.addedWrapp = !0),
    ...
    a.extend(e.prototype, {
        ...
        resizeEvent: function() {
            ...
            e["private"].resize.initEvent({
                ...
                fn: function() {
                    ...
                    a = b.$obj.outerWidth(),
                    b.width !== a && ("alignCenter" === b.options.gridAdjustment && (b.wrapper[0].style.maxWidth = ""),
                    b.width = a,
        ...
        gridAdjust: function() {
            var b = this;
            // if responsive
            "responsive" === b.options.gridAdjustment ? b.responsiveLayout() : (// reset the style attribute for all blocks so I can read a new width & height
        ...
        triggerEvent: function(a, b) {
            ...
            if (e.registeredEvents[a])
                for (c = 0,
                d = e.registeredEvents[a].length; d > c; c++)
...
function(a, b, c, d) {
    ...
    a.extend(e.prototype, {
        ...
        mosaicLayout: function() {
            ...
            for (// array of objects where I keep the spaces available in the grid
            b.freeSpaces = [{
                leftStart: 0,
            ...
            a = 0; c > a; a++) {
                ...
                if (d = b.getSpaceIndexAndBlock(),
                null === d)
                    // sort blocks
                    // after the sort is finished start the layout again
                    return b.sortBlocksToPreventGaps(),
                    void b.mosaicLayout();
        ...
        getSpaceIndexAndBlock: function() {
            ...
            return a.each(b.freeSpaces, function(d, e) {
                ...
                !b.blocksAreSorted && b.options.sortToPreventGaps && d > 0 ? (c = null,
                !1) : null !== c ? !1 : void 0
            }),
            c
        },
        ...
        removeNonMaximalFreeSpaces: function() {
            ...
            b.freeSpaces = a.map(b.freeSpaces, function(c, d) {
                return a.each(b.freeSpaces, function(a, b) {
                    return d !== a && b.leftStart <= c.leftStart && b.leftEnd >= c.leftEnd && b.topStart <= c.topStart && b.topEnd >= c.topEnd ? (c = null,
                    !1) : void 0
                }),
                c
            })
        ...
        uniqueFreeSpaces: function() {
            ...
            a.each(b.freeSpaces, function(b, d) {
                a.each(c, function(a, b) {
                    return b.leftStart === d.leftStart && b.leftEnd === d.leftEnd && b.topStart === d.topStart && b.topEnd === d.topEnd ? (d = null,
                    !1) : void 0
                }),
                null !== d && c.push(d)
            }),
    ...
    e["private"] = {
        publicEvents: function(b, c, d) {
            ...
            e.destroyEvent = function(c) {
                ...
                0 === e.events.length && // remove scroll event
                f.off(b)
            }
            ,
        ...
        browserInfo: function() {
            ...
            g.browser = "ios" : /chrome/gi.test(h) ? g.browser = "chrome" : g.browser = "",
        ...
        styleSupport: function(a) {
            var b, // capitalize first character of the prop to test vendor prefix
...
function(a, b, c, d) {
    ...
    a.extend(e.prototype, {
        ...
        destroySlider: function() {
            ...
            b.$ul.off(".cbp"),
            a(c).off(".cbp"),
            // @todo - don't interfer with the lightbox
...
function(a, b, c, d) {
        ...
        b.registerEvent("resetFiltersVisual", function() {
            ...
            c.filters.each(function(b, c) {
                ...
                a.each(d, function(a, b) {
                    ...
                    return c.length ? (c.addClass("cbp-filter-item-active").siblings().removeClass("cbp-filter-item-active"),
                    d.splice(a, 1),
                    !1) : void 0
                })
            }),
    ...
    e.prototype.registerFilter = function() {
        ...
        b.filters.each(function(e, f) {
            ...
            a.each(d, function(a, b) {
                return i.filter('[data-filter="' + b + '"]').length ? (h = b,
                d.splice(a, 1),
                !1) : void 0
            }),
            ...
            i.on("click.cbp", function() {
                ...
                if (!d.hasClass("cbp-filter-item-active") && !c.isAnimating) {
                    ...
                    e.length < 1 && (e = ["*"]);
                    var g = e.join("|");
                    c.defaultFilter !== g && // filter the items
...
function(a, b, c, d) {
    ...
    g["private"].lazyLoadScroll = new g["private"].publicEvents("scroll.lazyLoad",300),
...
function(a, b, c, d) {
    ...
    f["private"].loadMoreScroll = new f["private"].publicEvents("scroll.loadMore",100),
    ...
    e.prototype.click = function() {
        ...
        b.loadMore.on("click.cbp", function(d) {
            var e = a(this);
            d.preventDefault(),
            b.parent.isAnimating || e.hasClass("cbp-l-loadMore-stop") || (// set loading status
            ...
            a.ajax({
                ...
                b.parent.$obj.cubeportfolio("append", d.substring(h, g), function() {
            ...
            Object.create({
                ...
                addEvents: function() {
                    ...
                    f["private"].loadMoreScroll.initEvent({
                        instance: a,
                        fn: function() {
                            c.parent.isAnimating || // get new items on scroll
                            a.getNewItems()
                        }
                    }),
                ...
                getNewItems: function() {
                    var b, e, g = this;
                    g.isActive || c.loadMore.hasClass("cbp-l-loadMore-stop") || (b = c.loadMore.offset().top - 200,
                    ...
                    a.ajax({
                        ...
                        h = -1 === j ? b.lastIndexOf("</") : b.lastIndexOf("</", j),
                        c.parent.$obj.cubeportfolio("append", b.substring(i, h), function() {
                            -1 === j ? (c.loadMore.addClass("cbp-l-loadMore-stop"),
                            f["private"].loadMoreScroll.destroyEvent(this),
                            c.parent.$obj.off("filterComplete.cbp")) : (g.isActive = !1,
...
function(a, b, c, d) {
    ...
    var f = a.fn.cubeportfolio.constructor
      , g = {
        ...
        init: function(b, d) {
            var e, f = this;
            if (// remember cubeportfolio instance
            f.cubeportfolio = b,
            ...
            "singlePageInline" !== d) {
                if (// create markup, css and add events for lightbox and singlePage
                f.createMarkup(),
                "singlePage" === d && (f.cubeportfolio.registerEvent("resizeWindow", function() {
                ...
                f.options.singlePageDeeplinking)) {
                    ...
                    e) {
                        ...
                        l.setAttribute("href", g[0]),
                        f.openSinglePage([l], l)
                    }
                }
            } else if (f.height = 0,
            ...
            f.cubeportfolio.registerEvent("resizeGrid", function() {
                f.isOpen && // @todo must add support for this features in the future
                f.close()
            }),
        ...
        createMarkup: function() {
            ...
            "singlePage" === b.type && (b.options.singlePageCounter && (// counter for singlePage
            b.counter = a(b.options.singlePageCounter).appendTo(b.navigation),
            b.counter.text("")),
            ...
            a(c).on("keydown.cbp", function(a) {
                ...
                b.isOpen && (// if all events are stopped => return
            ...
            if (!i.isOpen) {
                ...
                a.each(d, function(b, c) {
                    ...
                    if (-1 === a.inArray(e, k)) {
                        if (f === e)
                            i.current = j;
                        else if (!i.options.lightboxGallery)
                            return;
                        /youtube/i.test(e) ? (d = e.substring(e.lastIndexOf("v=") + 2),
                        /autoplay=/i.test(d) || (d += "&autoplay=1"),
                        d = d.replace(/\?|&/, "?"),
                        g = "//www.youtube.com/embed/" + d,
                        h = "isYoutube") : /vimeo\.com/i.test(e) ? (d = e.substring(e.lastIndexOf("/") + 1),
                        /autoplay=/i.test(d) || (d += "&autoplay=1"),
                        d = d.replace(/\?|&/, "?"),
                        g = "//player.vimeo.com/video/" + d,
                        h = "isVimeo") : /www\.ted\.com/i.test(e) ? (g = "http://embed.ted.com/talks/" + e.substring(e.lastIndexOf("/") + 1) + ".html",
                        h = "isTed") : /soundcloud\.com/i.test(e) ? (g = e,
                        h = "isSoundCloud") : /(\.mp4)|(\.ogg)|(\.ogv)|(\.webm)/i.test(e) ? (g = -1 !== e.indexOf("|") ? e.split("|") : e.split("%7C"),
                        h = "isSelfHostedVideo") : /\.mp3$/i.test(e) && (g = e,
                        h = "isSelfHostedAudio"),
                        i.dataArray.push({
                            src: g,
                ...
                1 === i.counterTotal ? (i.nextButton.hide(),
                i.prevButton.hide(),
                i.dataActionImg = "") : (i.nextButton.show(),
                i.prevButton.show(),
        ...
        openSinglePage: function(d, e) {
            var g, h = this, i = 0, j = [];
            if (!h.isOpen) {
                if (// check singlePageInline and close it
                ...
                h.wrap.one(f["private"].transitionend, function() {
                    ...
                    "android" !== f["private"].browser && "ios" !== f["private"].browser || (// wrap element
                ...
                "ie8" !== f["private"].browser && "ie9" !== f["private"].browser || (// make the navigation sticky
                h.options.singlePageStickyNavigation && (h.navigationWrap.width(h.wrap[0].clientWidth),
                setTimeout(function() {
                ...
                // change link
                h.options.singlePageDeeplinking && (// ignore old #cbp from href
        ...
        openSinglePageInline: function(c, d, e) {
            ...
            // change link
            j.options.singlePageInlineDeeplinking && (// ignore old #cbpi from href
        ...
        updateSinglePageIsOpen: function() {
            ...
            "android" !== f["private"].browser && "ios" !== f["private"].browser || a("html").css({
                position: "fixed"
            }),
        ...
        close: function(c, d) {
            function e() {
                ...
                // hide the wrap
                i.wrap.detach(),
                i.cubeportfolio.$obj.removeClass("cbp-popup-singlePageInline-open cbp-popup-singlePageInline-close"),
                "promise" === c && a.isFunction(d.callback) && d.callback.call(i.cubeportfolio),
                i.resetWrap()
            }
            function g() {
            ...
            i.isOpen = !1,
            "singlePageInline" === i.type ? "open" === c ? (i.wrap.removeClass("cbp-popup-singlePageInline-ready"),
            a(i.dataArray[i.current].element).closest(".cbp-item").removeClass("cbp-singlePageInline-active"),
            i.openSinglePageInline(d.blocks, d.currentBlock, d.fromOpen)) : (i.height = 0,
            i.revertResizeSinglePageInline(),
            i.wrap.removeClass("cbp-popup-singlePageInline-ready"),
            i.cubeportfolio.$obj.addClass("cbp-popup-singlePageInline-close"),
            i.cubeportfolio.$obj.find(".cbp-item").removeClass("cbp-singlePageInline-active"),
            f["private"].modernBrowser ? i.wrap.one(f["private"].transitionend, function() {
                g()
            }) : g()) : "singlePage" === i.type ? (i.resetWrap(),
            ...
            setTimeout(function() {
                ...
                "ie8" !== f["private"].browser && "ie9" !== f["private"].browser || (i.content.html(""),
                i.wrap.detach(),
                a("html").css({
                    overflow: "",
                    marginRight: "",
            ...
            i.originalStyle ? a("html").attr("style", i.originalStyle) : a("html").css({
                overflow: "",
                marginRight: ""
            }),
            a(b).scrollTop(i.scrollTop),
    ...
    e.prototype.run = function() {
        ...
        d.lightbox = null,
        // LIGHTBOX
        d.options.lightboxDelegate && !i && (i = !0,
        ...
        d.singlePage = null,
        // SINGLEPAGE
        d.options.singlePageDelegate && !j && (j = !0,
        ...
        // SINGLEPAGEINLINE
        d.options.singlePageInlineDelegate && (d.singlePageInline = Object.create(g),
