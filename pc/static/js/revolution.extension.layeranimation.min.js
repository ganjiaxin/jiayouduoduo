...
!function(a) {
    ...
    jQuery.extend(!0, t, {
        ...
        animateSingleCaption: function(a, r, s, f, b, x, T) {
            ...
            if ("off" == O || Q < r.hideCaptionAtLimit && "on" == a.data("captionhidden") || Q < r.hideAllCaptionAtLimit ? a.addClass("tp-hidden-caption") : a.removeClass("tp-hidden-caption"),
            ...
            a.find("img").length > 0) {
                ...
                void 0 == B && (B = 0),
                void 0 == A && (A = 0),
                "off" !== k ? ("grid" != _ && P ? H.width(B) : H.width(B * r.bw),
                "grid" != _ && X ? H.height(A) : H.height(A * r.bh)) : (H.width(B),
                H.height(A))
            }
            "slide" === _ && (s = 0,
            f = 0);
            ...
            1 > xa && 1 != a.data("outstarted") || 2 == W || T) {
                ...
                if (!a.data("$anims") || T || Ra) {
                    ...
                    Qa && (_a = p(_a, a.data("transform_hover")),
                    ...
                    Qa && !a.hasClass("rs-hover-ready") && (a.addClass("rs-hover-ready"),
                    a.hover(function(a) {
                        ...
                        La.svg && e.data("newsvghoveranim", punchgs.TweenLite.to(La.svg, t.speed, e.data("hoversvg").anim))) : (e.data("newhoveranim").progress(0),
                ...
                if (Ca.f.anim.x = Ca.f.anim.x * r.bw || l(Ca.f.anim.x, r, ra, da, wa, fa, "horizontal"),
                Ca.f.anim.y = Ca.f.anim.y * r.bw || l(Ca.f.anim.y, r, ra, da, wa, fa, "vertical"),
                2 != W || T) {
                    if (Wa != a) {
                    ...
                    if (Ca.f.anim.visibility = "hidden",
                    a.data("eow", ra),
                    a.data("eoh", da),
