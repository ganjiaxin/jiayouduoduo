...
!function(e) {
    ...
    jQuery.extend(!0, a, {
        ...
        manageVideoLayer: function(e, o, n, s) {
            ...
            switch (e.data("videotype", k),
            x) {
            case "html5":
                "controls" != h && (h = "");
                var T = "video";
                "html5" == e.data("audio") && (T = "audio",
            ...
            if (void 0 != e.data("videoposter") && e.data("videoposter").length > 2 && !_)
                ...
                if (i && 1 == e.data("disablevideoonmobile"))
                    return !1;
                0 != e.find("iframe").length || "youtube" != k && "vimeo" != k || (e.append(e.data("videomarkup")),
                r(e, o, !1))
            }
    ...
    var d = function(e, t, a) {
                    ...
                    events: {
                        onStateChange: function(i) {
                            ...
                            if (i.data == YT.PlayerState.PLAYING)
                                ...
                                "mute" == e.data("volume") || a.lastToggleState(e.data("videomutetoggledby")) || d.globalmute === !0 ? m.mute() : (m.unMute(),
      ...
      , s = function() {
        ...
        var t = 5;
        return e.browser.webkit && /Apple Computer/.test(navigator.vendor) && (t = 42),
        screen.width == window.innerWidth && Math.abs(screen.height - window.innerHeight) < t
    }
      , l = function(e, r, l) {
        if (i && 1 == e.data("disablevideoonmobile"))
            return !1;
        ...
        if (m = "loop" == m || "loopandnoslidestop" == m,
        f.data("metaloaded", 1),
